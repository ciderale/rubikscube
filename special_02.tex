...
\tikzset{default/.style={anchor=north east,text width=1.9cm,yshift=-0.1cm,font=\sffamily\bfseries}}
\draw (Rot2Start) node[default]{a-b-c-d\\counter\\clockwise};
\draw (Rot2End) node[default]{red\\yellow\\green\\clockwise};
}
